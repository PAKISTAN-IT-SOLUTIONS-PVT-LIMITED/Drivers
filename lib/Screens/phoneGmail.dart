...
class PhoneGmail extends StatefulWidget {
  @override
  _PhoneGmailState createState() => _PhoneGmailState();
}

class _PhoneGmailState extends State<PhoneGmail> {
  ...
  String phone;
  String sign;
  // String userEmail, userName, userPhoto, userId;
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        SharedPreferences sharedPreferences =
                            await SharedPreferences.getInstance();
                        String userEmail = sharedPreferences.get("userEmail");
                        String userName = sharedPreferences.get("userName");
                        String userPhoto = sharedPreferences.get("userPhoto");
                        String userId = sharedPreferences.get("userId");
                        String userPhone = sharedPreferences.get("phone");
                        print('===========================================');
                        print(userEmail);
                        print(userPhone);
                        print('============================================');
                        CreateUserAccount().addUser(userEmail, userName, "",
                            userPhone, userPhoto, userId);
                      },
                      child: Container(
